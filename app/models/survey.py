...
class Survey(db.Model):
    ...
    compensation = db.Column(db.Numeric(), nullable=False, default=0)
    ...
    def from_dict(cls, survey_data):
        try:
            new_survey = cls(
                ...
                compensation=survey_data["compensation"],
    ...
    def to_dict(self):
        ...
        survey_dict["compensation"] = self.compensation
        ...
        survey_dict["payment_left"] = self.payment_left
